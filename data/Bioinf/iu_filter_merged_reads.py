...
file = open("iu-filter-merged-reads_KI_Platy.sh", "w") # Initialize new file iu-filter-merged-reads_KI_Platy.sh. "w" means write a new file, Note: will clobber files with the same name!
