...
startdate <- as.POSIXct("2014-07-01 00:00:00",tz="Pacific/Kiritimati", format="%Y-%m-%d %H:%M:%S")
...
jpeg(file="figures/Figure1a_pres_ECRS.jpg",width = 7.2, height = 2.25,units="in",res=300)

# Set both inner and outer margins to 0
par(oma=c(0,0,0,0),mar=c(2.5,3.5,0.25,2.5),bg="black",col.lab="gray30")
...
axis.POSIXct(side=1,KI_heat$time,
             at=seq(KI_heat$time[1],KI_heat$time[249],by="month"),
             tck=0.03,cex.axis=0.93,
             format="%b",
             lwd.ticks=1.5,padj=-1.5,col="gray30",col.axis="gray30")
axis.POSIXct(side=1,KI_heat$time,cex.axis=0.93,tck=0,padj=0,col="gray30",col.axis="gray30")
