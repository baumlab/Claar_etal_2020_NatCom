...
# Plot top panel
temp <- read.csv("thistout_kiritimati.csv", sep=",", header=FALSE)
mtime <- read.csv("timevec_kiritimati.csv", sep=",", header=FALSE)
dhw <- read.csv("histout_kiritimati.csv", sep=",", header=FALSE)
time <- "NA"
...
plot_jpeg('KI2014_site35_99.jpg')
plot_jpeg('KI2015a_site35_99_after.jpg')
plot_jpeg('KI2015c_site35_99.jpg')
plot_jpeg('KI2016a_site35_99.jpg')
plot_jpeg('KI2016b_site35_99.jpg')
