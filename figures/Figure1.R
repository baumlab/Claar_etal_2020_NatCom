...
layout(matrix(c(1,1,1,1,1,2,3,4,5,6), nrow=2, ncol=5, byrow = TRUE), heights=c(0.5,0.3))
# Plot top panel
...
KI2015a <- as.POSIXct("2015-01-25 00:00:00",tz="Pacific/Kiritimati", format="%Y-%m-%d %H:%M:%S")
...
title(ylab="Degree Heating Weeks", line=0.5, cex.lab=1.2)
