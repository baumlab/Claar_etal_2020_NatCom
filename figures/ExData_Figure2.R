...
rac.before.temp <- data.frame(sort(taxa_sums(phy97.f.c.coral.AD.before.LVL)))
rac.before.temp$otu<-rownames(rac.before.temp)
colnames(rac.before.temp)[1] <- "Abundance"
rac.before <- merge(rac.before.temp, data.frame(tax_table(phy97.f.c.coral.AD.before.LVL)), by="otu")
...
mtext(paste("n = ",nsamples(phy97.f.c.coral.AD.after.HVH)," samples 
            (",max.abund," sequences)",sep=""),side=3,line=-2,adj=0.9,cex=0.75)

# Low Disturbance: during
rac.during.temp <- data.frame(sort(taxa_sums(phy97.f.c.coral.AD.during.LVL)))
rac.during.temp$otu<-rownames(rac.during.temp)
colnames(rac.during.temp)[1] <- "Abundance"
rac.during <- merge(rac.during.temp, data.frame(tax_table(phy97.f.c.coral.AD.during.LVL)), by="otu")
...
mtext(paste("n = ",nsamples(phy97.f.c.coral.AD.during.LVL)," samples 
            (",max.abund," sequences)",sep=""),side=3,line=-2,adj=0.9,cex=0.75)

# Low Disturbance: after
rac.after.temp <- data.frame(sort(taxa_sums(phy97.f.c.coral.AD.after.LVL)))
rac.after.temp$otu<-rownames(rac.after.temp)
colnames(rac.after.temp)[1] <- "Abundance"
rac.after <- merge(rac.after.temp, data.frame(tax_table(phy97.f.c.coral.AD.after.LVL)), by="otu")
...
mtext(paste("n = ",nsamples(phy97.f.c.coral.AD.after.LVL)," samples 
            (",max.abund," sequences)",sep=""),side=3,line=-2,adj=0.9,cex=0.75)

# Medium Disturbance: before
rac.before.temp <- data.frame(sort(taxa_sums(phy97.f.c.coral.AD.before.HM)))
rac.before.temp$otu<-rownames(rac.before.temp)
colnames(rac.before.temp)[1] <- "Abundance"
rac.before <- merge(rac.before.temp, data.frame(tax_table(phy97.f.c.coral.AD.before.HM)), by="otu")
...
mtext(paste("n = ",nsamples(phy97.f.c.coral.AD.before.HM)," samples 
            (",max.abund," sequences)",sep=""),side=3,line=-2,adj=0.9,cex=0.75)

# Medium Disturbance: during
rac.during.temp <- data.frame(sort(taxa_sums(phy97.f.c.coral.AD.during.HM)))
rac.during.temp$otu<-rownames(rac.during.temp)
colnames(rac.during.temp)[1] <- "Abundance"
rac.during <- merge(rac.during.temp, data.frame(tax_table(phy97.f.c.coral.AD.during.HM)), by="otu")
...
mtext(paste("n = ",nsamples(phy97.f.c.coral.AD.during.HM)," samples 
            (",max.abund," sequences)",sep=""),side=3,line=-2,adj=0.9,cex=0.75)

# Medium Disturbance: after
rac.after.temp <- data.frame(sort(taxa_sums(phy97.f.c.coral.AD.after.HM)))
rac.after.temp$otu<-rownames(rac.after.temp)
colnames(rac.after.temp)[1] <- "Abundance"
rac.after <- merge(rac.after.temp, data.frame(tax_table(phy97.f.c.coral.AD.after.HM)), by="otu")
...
mtext(paste("n = ",nsamples(phy97.f.c.coral.AD.after.HM)," samples 
            (",max.abund," sequences)",sep=""),side=3,line=-2,adj=0.9,cex=0.75)

# High Disturbance: before
rac.before.temp <- data.frame(sort(taxa_sums(phy97.f.c.coral.AD.before.HVH)))
rac.before.temp$otu<-rownames(rac.before.temp)
colnames(rac.before.temp)[1] <- "Abundance"
rac.before <- merge(rac.before.temp, data.frame(tax_table(phy97.f.c.coral.AD.before.HVH)), by="otu")
...
mtext(paste("n = ",nsamples(phy97.f.c.coral.AD.before.HVH)," samples 
            (",max.abund," sequences)",sep=""),side=3,line=-2,adj=0.9,cex=0.75)

# High Disturbance: during
rac.during.temp <- data.frame(sort(taxa_sums(phy97.f.c.coral.AD.during.HVH)))
rac.during.temp$otu<-rownames(rac.during.temp)
colnames(rac.during.temp)[1] <- "Abundance"
rac.during <- merge(rac.during.temp, data.frame(tax_table(phy97.f.c.coral.AD.during.HVH)), by="otu")
...
mtext(paste("n = ",nsamples(phy97.f.c.coral.AD.during.HVH)," samples 
            (",max.abund," sequences)",sep=""),side=3,line=-2,adj=0.9,cex=0.75)

# High Disturbance: after
rac.after.temp <- data.frame(sort(taxa_sums(phy97.f.c.coral.AD.after.HVH)))
rac.after.temp$otu<-rownames(rac.after.temp)
colnames(rac.after.temp)[1] <- "Abundance"
rac.after <- merge(rac.after.temp, data.frame(tax_table(phy97.f.c.coral.AD.after.HVH)), by="otu")
...
# #################### FPENTA ###################
# # Low Disturbance: before
# rac.before.temp <- data.frame(sort(taxa_sums(phy97.f.c.fpenta.AD.before.LVL)))
# rac.before.temp$otu<-rownames(rac.before.temp)
# colnames(rac.before.temp)[1] <- "Abundance"
# rac.before <- merge(rac.before.temp, data.frame(tax_table(phy97.f.c.fpenta.AD.before.LVL)), by="otu")
# rac.before.LVL <- rac.before[order(-rac.before$Abundance),]
# max.abund <- max(rac.before.LVL$Abundance)
# rac.before.LVL$Abundance <- (rac.before.LVL$Abundance)/max.abund*100
# rac.before.LVL$hit <- gsub("_.*", "", rac.before$hit)
...
# 
# # Medium Disturbance: before
# rac.before.temp <- data.frame(sort(taxa_sums(phy97.f.c.fpenta.AD.before)))
# rac.before.temp$otu<-rownames(rac.before.temp)
# colnames(rac.before.temp)[1] <- "Abundance"
# rac.before <- merge(rac.before.temp, data.frame(tax_table(phy97.f.c.fpenta.AD.before.HM)), by="otu")
# rac.before.HM <- rac.before[order(-rac.before$Abundance),]
# max.abund <- max(rac.before.HM$Abundance)
# rac.before.HM$Abundance <- (rac.before.HM$Abundance)/max.abund*100
# rac.before.HM$hit <- gsub("_.*", "", rac.before$hit)
...
# 
# # High Disturbance: before
# rac.before.temp <- data.frame(sort(taxa_sums(phy97.f.c.fpenta.AD.before.HVH)))
# rac.before.temp$otu<-rownames(rac.before.temp)
# colnames(rac.before.temp)[1] <- "Abundance"
# rac.before <- merge(rac.before.temp, data.frame(tax_table(phy97.f.c.fpenta.AD.before.HVH)), by="otu")
# rac.before.HVH <- rac.before[order(-rac.before$Abundance),]
# max.abund <- max(rac.before.HVH$Abundance)
# rac.before.HVH$Abundance <- (rac.before.HVH$Abundance)/max.abund*100
# rac.before.HVH$hit <- gsub("_.*", "", rac.before$hit)
...
# 
# # Low Disturbance: during
# rac.during.temp <- data.frame(sort(taxa_sums(phy97.f.c.fpenta.AD.during.LVL)))
# rac.during.temp$otu<-rownames(rac.during.temp)
# colnames(rac.during.temp)[1] <- "Abundance"
# rac.during <- merge(rac.during.temp, data.frame(tax_table(phy97.f.c.fpenta.AD.during.LVL)), by="otu")
# rac.during.LVL <- rac.during[order(-rac.during$Abundance),]
# max.abund <- max(rac.during.LVL$Abundance)
# rac.during.LVL$Abundance <- (rac.during.LVL$Abundance)/max.abund*100
# rac.during.LVL$hit <- gsub("_.*", "", rac.during$hit)
...
# 
# # Medium Disturbance: during
# rac.during.temp <- data.frame(sort(taxa_sums(phy97.f.c.fpenta.AD.during)))
# rac.during.temp$otu<-rownames(rac.during.temp)
# colnames(rac.during.temp)[1] <- "Abundance"
# rac.during <- merge(rac.during.temp, data.frame(tax_table(phy97.f.c.fpenta.AD.during.HM)), by="otu")
# rac.during.HM <- rac.during[order(-rac.during$Abundance),]
# max.abund <- max(rac.during.HM$Abundance)
# rac.during.HM$Abundance <- (rac.during.HM$Abundance)/max.abund*100
# rac.during.HM$hit <- gsub("_.*", "", rac.during$hit)
...
# 
# # High Disturbance: during
# rac.during.temp <- data.frame(sort(taxa_sums(phy97.f.c.fpenta.AD.during.HVH)))
# rac.during.temp$otu<-rownames(rac.during.temp)
# colnames(rac.during.temp)[1] <- "Abundance"
# rac.during <- merge(rac.during.temp, data.frame(tax_table(phy97.f.c.fpenta.AD.during.HVH)), by="otu")
# rac.during.HVH <- rac.during[order(-rac.during$Abundance),]
# max.abund <- max(rac.during.HVH$Abundance)
# rac.during.HVH$Abundance <- (rac.during.HVH$Abundance)/max.abund*100
# rac.during.HVH$hit <- gsub("_.*", "", rac.during$hit)
...
# 
# # Low Disturbance: after
# rac.after.temp <- data.frame(sort(taxa_sums(phy97.f.c.fpenta.AD.after.LVL)))
# rac.after.temp$otu<-rownames(rac.after.temp)
# colnames(rac.after.temp)[1] <- "Abundance"
# rac.after <- merge(rac.after.temp, data.frame(tax_table(phy97.f.c.fpenta.AD.after.LVL)), by="otu")
# rac.after.LVL <- rac.after[order(-rac.after$Abundance),]
# max.abund <- max(rac.after.LVL$Abundance)
# rac.after.LVL$Abundance <- (rac.after.LVL$Abundance)/max.abund*100
# rac.after.LVL$hit <- gsub("_.*", "", rac.after$hit)
...
# 
# # Medium Disturbance: after
# rac.after.temp <- data.frame(sort(taxa_sums(phy97.f.c.fpenta.AD.after)))
# rac.after.temp$otu<-rownames(rac.after.temp)
# colnames(rac.after.temp)[1] <- "Abundance"
# rac.after <- merge(rac.after.temp, data.frame(tax_table(phy97.f.c.fpenta.AD.after.HM)), by="otu")
# rac.after.HM <- rac.after[order(-rac.after$Abundance),]
# max.abund <- max(rac.after.HM$Abundance)
# rac.after.HM$Abundance <- (rac.after.HM$Abundance)/max.abund*100
# rac.after.HM$hit <- gsub("_.*", "", rac.after$hit)
...
# 
# # High Disturbance: after
# rac.after.temp <- data.frame(sort(taxa_sums(phy97.f.c.fpenta.AD.after.HVH)))
# rac.after.temp$otu<-rownames(rac.after.temp)
# colnames(rac.after.temp)[1] <- "Abundance"
# rac.after <- merge(rac.after.temp, data.frame(tax_table(phy97.f.c.fpenta.AD.after.HVH)), by="otu")
# rac.after.HVH <- rac.after[order(-rac.after$Abundance),]
# max.abund <- max(rac.after.HVH$Abundance)
# rac.after.HVH$Abundance <- (rac.after.HVH$Abundance)/max.abund*100
# rac.after.HVH$hit <- gsub("_.*", "", rac.after$hit)
...
# ######################## PLATY ###################################
# # Low Disturbance: before
# rac.before.temp <- data.frame(sort(taxa_sums(phy97.f.c.platy.AD.before.LVL)))
# rac.before.temp$otu<-rownames(rac.before.temp)
# colnames(rac.before.temp)[1] <- "Abundance"
# rac.before <- merge(rac.before.temp, data.frame(tax_table(phy97.f.c.platy.AD.before.LVL)), by="otu")
# rac.before.LVL <- rac.before[order(-rac.before$Abundance),]
# max.abund <- max(rac.before.LVL$Abundance)
# rac.before.LVL$Abundance <- (rac.before.LVL$Abundance)/max.abund*100
# rac.before.LVL$hit <- gsub("_.*", "", rac.before$hit)
...
# 
# # Medium Disturbance: before
# rac.before.temp <- data.frame(sort(taxa_sums(phy97.f.c.platy.AD.before)))
# rac.before.temp$otu<-rownames(rac.before.temp)
# colnames(rac.before.temp)[1] <- "Abundance"
# rac.before <- merge(rac.before.temp, data.frame(tax_table(phy97.f.c.platy.AD.before.HM)), by="otu")
# rac.before.HM <- rac.before[order(-rac.before$Abundance),]
# max.abund <- max(rac.before.HM$Abundance)
# rac.before.HM$Abundance <- (rac.before.HM$Abundance)/max.abund*100
# rac.before.HM$hit <- gsub("_.*", "", rac.before$hit)
...
# 
# # High Disturbance: before
# rac.before.temp <- data.frame(sort(taxa_sums(phy97.f.c.platy.AD.before.HVH)))
# rac.before.temp$otu<-rownames(rac.before.temp)
# colnames(rac.before.temp)[1] <- "Abundance"
# rac.before <- merge(rac.before.temp, data.frame(tax_table(phy97.f.c.platy.AD.before.HVH)), by="otu")
# rac.before.HVH <- rac.before[order(-rac.before$Abundance),]
# max.abund <- max(rac.before.HVH$Abundance)
# rac.before.HVH$Abundance <- (rac.before.HVH$Abundance)/max.abund*100
# rac.before.HVH$hit <- gsub("_.*", "", rac.before$hit)
...
# 
# # Low Disturbance: during
# rac.during.temp <- data.frame(sort(taxa_sums(phy97.f.c.platy.AD.during.LVL)))
# rac.during.temp$otu<-rownames(rac.during.temp)
# colnames(rac.during.temp)[1] <- "Abundance"
# rac.during <- merge(rac.during.temp, data.frame(tax_table(phy97.f.c.platy.AD.during.LVL)), by="otu")
# rac.during.LVL <- rac.during[order(-rac.during$Abundance),]
# max.abund <- max(rac.during.LVL$Abundance)
# rac.during.LVL$Abundance <- (rac.during.LVL$Abundance)/max.abund*100
# rac.during.LVL$hit <- gsub("_.*", "", rac.during$hit)
...
# 
# # Medium Disturbance: during
# rac.during.temp <- data.frame(sort(taxa_sums(phy97.f.c.platy.AD.during)))
# rac.during.temp$otu<-rownames(rac.during.temp)
# colnames(rac.during.temp)[1] <- "Abundance"
# rac.during <- merge(rac.during.temp, data.frame(tax_table(phy97.f.c.platy.AD.during.HM)), by="otu")
# rac.during.HM <- rac.during[order(-rac.during$Abundance),]
# max.abund <- max(rac.during.HM$Abundance)
# rac.during.HM$Abundance <- (rac.during.HM$Abundance)/max.abund*100
# rac.during.HM$hit <- gsub("_.*", "", rac.during$hit)
...
# 
# # High Disturbance: during
# rac.during.temp <- data.frame(sort(taxa_sums(phy97.f.c.platy.AD.during.HVH)))
# rac.during.temp$otu<-rownames(rac.during.temp)
# colnames(rac.during.temp)[1] <- "Abundance"
# rac.during <- merge(rac.during.temp, data.frame(tax_table(phy97.f.c.platy.AD.during.HVH)), by="otu")
# rac.during.HVH <- rac.during[order(-rac.during$Abundance),]
# max.abund <- max(rac.during.HVH$Abundance)
# rac.during.HVH$Abundance <- (rac.during.HVH$Abundance)/max.abund*100
# rac.during.HVH$hit <- gsub("_.*", "", rac.during$hit)
...
# 
# # Low Disturbance: after
# rac.after.temp <- data.frame(sort(taxa_sums(phy97.f.c.platy.AD.after.LVL)))
# rac.after.temp$otu<-rownames(rac.after.temp)
# colnames(rac.after.temp)[1] <- "Abundance"
# rac.after <- merge(rac.after.temp, data.frame(tax_table(phy97.f.c.platy.AD.after.LVL)), by="otu")
# rac.after.LVL <- rac.after[order(-rac.after$Abundance),]
# max.abund <- max(rac.after.LVL$Abundance)
# rac.after.LVL$Abundance <- (rac.after.LVL$Abundance)/max.abund*100
# rac.after.LVL$hit <- gsub("_.*", "", rac.after$hit)
...
# 
# # Medium Disturbance: after
# rac.after.temp <- data.frame(sort(taxa_sums(phy97.f.c.platy.AD.after)))
# rac.after.temp$otu<-rownames(rac.after.temp)
# colnames(rac.after.temp)[1] <- "Abundance"
# rac.after <- merge(rac.after.temp, data.frame(tax_table(phy97.f.c.platy.AD.after.HM)), by="otu")
# rac.after.HM <- rac.after[order(-rac.after$Abundance),]
# max.abund <- max(rac.after.HM$Abundance)
# rac.after.HM$Abundance <- (rac.after.HM$Abundance)/max.abund*100
# rac.after.HM$hit <- gsub("_.*", "", rac.after$hit)
...
# 
# # High Disturbance: after
# rac.after.temp <- data.frame(sort(taxa_sums(phy97.f.c.platy.AD.after.HVH)))
# rac.after.temp$otu<-rownames(rac.after.temp)
# colnames(rac.after.temp)[1] <- "Abundance"
# rac.after <- merge(rac.after.temp, data.frame(tax_table(phy97.f.c.platy.AD.after.HVH)), by="otu")
# rac.after.HVH <- rac.after[order(-rac.after$Abundance),]
# max.abund <- max(rac.after.HVH$Abundance)
# rac.after.HVH$Abundance <- (rac.after.HVH$Abundance)/max.abund*100
# rac.after.HVH$hit <- gsub("_.*", "", rac.after$hit)
