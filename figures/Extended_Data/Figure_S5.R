...
jpeg(file="figures/Extended_Data/Figure_S5.jpg",width=18, height=7,units="in", res=300)
plottree
dev.off()

tiff(file="figures/Extended_Data/Figure_S5.tiff",width=18, height=7,units="in", res=300)
plottree
dev.off()
