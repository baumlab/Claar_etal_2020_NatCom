...
D_cols <- c("Very High"="#8c510a", "High"="#5a749e", "Medium"="#5a749e", "Low"="#5a749e", "Very Low"="#5a749e")
...
jpeg(file="figures/Extended_Data/TechnicalResponse2.jpeg", height=8, width=15, units = "in",res = 300)
p
dev.off()

tiff(file="figures/Extended_Data/TechnicalResponse2.tiff", height=8, width=15, units = "in",res = 300)
p
dev.off()

png(file="figures/Extended_Data/TechnicalResponse2.png", height=8, width=15, units = "in",res = 300)
p
dev.off()
...
plot<-image_read("figures/Extended_Data/TechnicalResponse2.png")
...
image_write(final_plot, path = "figures/Extended_Data/TechnicalResponse2_2.png", format = "png")
image_write(final_plot, path = "figures/Extended_Data/TechnicalResponse2_2.jpeg", format = "jpeg")
