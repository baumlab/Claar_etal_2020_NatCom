...
box(lwd=1)
axis(1,lwd=0.2, at=c(-180, -140, -100),cex.axis=0.8, labels=c(expression(paste(180, degree, "W")), expression(paste(140, degree, "W")), expression(paste(100, degree, "W"))))
axis(2, las=2,lwd=0.2, at=c(-40, 0, 40), cex.axis=0.8, labels=c(expression(paste(40, degree, "S")), expression(paste(0, degree)), expression(paste(40, degree, "N"))))
