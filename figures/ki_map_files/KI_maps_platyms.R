...
villages<-data.frame(c(1.989386333, 2.022090868, 1.983594483, 1.865048333, 1.66))
villages$lon<-c(-157.4760637, -157.4884092, -157.3683462, -157.5522183, -157.5522183)
...
text(-157.47, 1.66, "Village with 500 people", cex=1.1)   
