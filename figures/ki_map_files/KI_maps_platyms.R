...
#with(sites_platy, text(lon, lat, label=site, cex=0.7))
legend(-157.265, 2.08,legend=levels(sites$f.pressure), pt.bg=c("#8c510a","#d8b365","#c7eae5","#5ab4ac","#01665e"), pch=21, bty="n", pt.cex=1.8, cex=0.7)
text(-157.275, 2.01, "Human disturbance", srt=90, cex=0.7)
