...
setwd("/Users/KristinaTietjen/Documents/Git_Hub/KI_Platy/figures")
#tiff(file="KI_map_platysites_villages_bigger.tiff",width = 7, height = 7,units="in",res=300)
#jpeg(file="KI_map_platysites_villages_bigger.jpeg",width = 7, height = 7,units="in",res=300)
pdf(file="KI_map_platysites_villages_bigger.pdf")
