...
tiff(file="figures/Extended Data/ExData_Figure1.tiff",width = 5.65, height = 6,units="in",res=300)
...
img_coral741_site32_July17 <- load.image('figures/Extended Data/coral741_site32_July17_KT_IMG_6762.jpg')
