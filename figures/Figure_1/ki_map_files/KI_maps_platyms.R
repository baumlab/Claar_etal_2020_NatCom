...
###village data
villages<-read.csv("figures/Figure_1/ki_map_files/KI_villagesDCC_2015update.csv", header = TRUE) # you get an error but it works
...
#tiff(file="figures/Figure_1/KI_map_platysites_villages_bigger.tiff",width = 7.6, height = 7.2,units="in",res=300)
#jpeg(file="figures/Figure_1/KI_map_platysites_villages_bigger.jpeg",width = 7.6, height = 7.2,units="in",res=300)
# jpeg(file="figures/Figure_1/KI_map_platysites_villages.jpeg",width = 7.6, height = 7.2,units="in",res=300)
#pdf(file="figures/Figure_1/KI_map_platysites_villages_bigger.pdf", width = 7.5, height =7)
...
pdf(file="figures/Figure_1/KI_map_platysites_villages.pdf",width = 7.6, height = 7.2,useDingbats = FALSE)  # just 'village'
source("figures/Figure_1/ki_map_files/KI_base_B&W_bigger.R")
...
text(-157.53, 1.82, "Vaskess\nBay", cex = 0.5)
text(-157.592, 2.078, "B", font=2, cex=1.25)
#source("figures/Figure_1/ki_map_files/KI_base_inset.R")
