...
Coral bleaching susceptibility is determined by fine-scale variability in their compliment of associated symbionts (Sampayo et al 2008). The symbiosis between coral and their single-celled dinoflagellate symbionts, Symbiodinium, is the foundation of reef ecosystems, and a critical element of reef resilience (van oppen and gates 2006). Corals host a diverse community of Symbiodinium, ranging along a continuum from 'selfish opportunistic symbionts' (e.g. some clade D Symbiodinium) which are better suited to sustained environmental stress, to 'intimately evolved symbionts' which provide exceptional amounts of nutrition to their coral host (@Stat:2006ww , @Lesser:2013tu). CLADES AND TYPES DEFINITION HERE. Despite the consensus that coral symbioses are integral to coral resistance to and resilience from bleaching, it is thought that most background Symbiodinium types have minimal functional significance for corals (Lee et al 2016), and . .
...
We do know that corals house background symbionts in low abundances (@Correa:2009jy, all the recent ngs studies...), but these relationships have been described as unstable (@Coffroth:2010ju, more cites?). We demonstrate that tiny abundances are important - many corals who switched from C to D during the event had extremely low or undetectable sequence counts of clade D *Symbiodinium* before the bleaching event, but their recovery symbiont communities were dominated by clade D *Symbiodinium* 
