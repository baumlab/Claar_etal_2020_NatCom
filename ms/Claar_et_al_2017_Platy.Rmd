...
1. Despite unprecedented heat stress, we show that some corals exhibited resilience and survived. Survival through such an extreme heat even provides an exceptional opportunity to study/to understand HOW some corals are able to do so. i.e. how some corals can withstand intense heat stress and how corals in general might survive long-term warming.
"Remarkably, we find that some coral colonies were able to survive this prolonged heat stress by regaining their symbionts while temperatures were still elevated"

2. Lack of preferential symbiont expulsion

3. Symbionts present in even very low abundances can play a critical role in coral recovery;

4. Local protection important i.e. corals living in sites with distinct levels of local disturbance had distinct symbiont communities that corresponded tightly to survivorship. 
...
The "transient microbiome" assembled by environmental anomalies can undergo rapid changes (Putnam et al 2017), providing symbiotic stochasticity which may build or weaken a coral's capacity for resilience. While corals can change symbiotic partners during a bleaching event, there is often a quick return to pre-bleaching Symbiodinium communities after recovery (Thornhill 2005, LaJeunesse et al 2010), and persistence of stress-related changes to Symbiodinium community structure may require sustained environmental pressure (Baird et al 2007). However, shifts in Symbiodinium community diversity may have a larger influence on coral resilience than the evolution of symbiont thermal tolerance (Baskett et al 2010). Corals commonly host background Symbiodinium types in low levels (Correa et al 2009), but sub-dominant Symbiodinium communities are often unstable (Coffroth et al 2010).  
