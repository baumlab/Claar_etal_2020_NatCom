...
clust100() {
	s=`echo $1 | grep -Eoh 'coral99.*'`
	pick_otus.py -i $1 -s 1 --denovo_otu_id_prefix $s'_denovo' --optimal_uclust -o /home/ross/KI_Platy/data/fasta/split_combined_trimmed_seqs/coral99/
}
export -f clust100
/home/ross/bin/parallel clust100 ::: /home/ross/KI_Platy/data/fasta/split_combined_trimmed_seqs/coral99/*.fasta

# Pick representative sequence set for each sample
repset100() {
	s=`echo $1 | grep -Eoh 'coral99.*fasta'`
	pick_rep_set.py -i $1 -m most_abundant -f $s -o $s'_rep_set.fasta'
}
export -f repset100
/home/ross/bin/parallel repset100 ::: /home/ross/KI_Platy/data/fasta/split_combined_trimmed_seqs/coral99/coral99*_otus.txt

# Merge all rep sets together
cat data/otus_97_bysample/KI*_rep_set.fasta > data/otus_97_bysample/all_rep_set.fasta
