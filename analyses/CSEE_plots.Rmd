...
# Plot it and scale colour manually
tiff(file="C:/Users/Dani/Documents/Data_Analysis/KI_Platy/analyses/CSEE_platy_ord.tiff",width = 6, height = 4,units="in",res=200)
p2 + scale_colour_manual(values = cols) + theme(panel.background = element_rect(fill = "black"), 
                                                ...
                                                panel.grid.minor = element_blank())+ geom_text(aes(label = clade), size = 5,hjust=-.5)
dev.off()

# Create the sample plot
p3 = plot_ordination(platy.before, platy.ord, type="samples", color="Status") 
# Plot it and scale colour manually
tiff(file="C:/Users/Dani/Documents/Data_Analysis/KI_Platy/analyses/CSEE_platy_ord_samples.tiff",width = 6, height = 4,units="in",res=200)
p3 + scale_colour_manual(values = cols[2:3]) + theme(panel.background = element_rect(fill = "black"), 
                                                ...
                                                axis.title = element_text(size=14,color="white"),
                                                panel.grid.major = element_blank(), 
                                                panel.grid.minor = element_blank()) +stat_ellipse(type = "norm", linetype = 2,size=1) +geom_point(size=5)
dev.off()
...
bar.D.clade <- plot_bar(platy.before.D,fill="clade")+
  theme(panel.background = element_rect(fill = "black"), 
        ...
        panel.grid.minor = element_blank(),
        text = element_text(size=10))+scale_fill_manual(values=clade.colors)
tiff(file="C:/Users/Dani/Documents/Data_Analysis/KI_Platy/analyses/CSEE_platy_bar.tiff",width = 8, height = 4,units="in",res=200)
...
ggplot(dat=test5, aes(x=D, y=C,color=Year_Pre_Post))+geom_point(size=3)+
    theme(panel.background = element_rect(fill = "black"), 
        plot.background = element_rect(fill = "black"),
        legend.position = "right",
        legend.text = element_text(size=14,color="white"),
...
ggplot(dat=test4, aes(x=D, y=C,color=Year_Pre_Post))+geom_point(size=3)+
    theme(panel.background = element_rect(fill = "black"), 
        plot.background = element_rect(fill = "black"),
        legend.position = "right",
        legend.text = element_text(size=14,color="white"),
...
ggplot(dat=test4, aes(x=Year_Pre_Post, y=C,color=Status))+geom_point(size=3)+
    theme(panel.background = element_rect(fill = "black"), 
        plot.background = element_rect(fill = "black"),
        legend.position = "right",
        legend.text = element_text(size=14,color="white"),
        ...
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        text = element_text(size=10))+scale_fill_manual(values=clade.colors) + stat_summary(fun.y = "mean", colour = "red", size = 2, geom = "point")
...
tiff(file="C:/Users/Dani/Documents/Data_Analysis/KI_Platy/analyses/CSEE_platy_CtoD.tiff",width = 7, height = 4,units="in",res=300)
