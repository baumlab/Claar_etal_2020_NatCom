...
```{r, echo=FALSE}
# Find all entries in the taxa_table that contain D1 in "hit"
...
save(list=c("phy97.f.clade","phy97.f.clade.p","phy97.f.eqtaxa","phy97.f.eqtaxa.p","phy97.f"),file = "C:/Users/Dani/Documents/Data_Analysis/KI_Platy/data/otus_97/KI_Platy_f_grouped.RData")
```
