...
rownames(df2) <- c("Number of OTUs","Number of Clades")
df2 <- t(df2)

df2

colors <- data.frame(sample_data(phy97.f.c))$Dist
...
barplot(df2, names.arg=c("Number of OTUs","Number of Clades"), beside=TRUE, legend=rownames(df), col=colors,ylim = c(0,25))
