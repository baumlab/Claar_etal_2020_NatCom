...
rownames(df2) <- c("Number of OTUs","Number of Clades", "Dist", "Number of Subclades")
df2 <- t(df2)
df2 <- df2[order(df2[,3]),]
df2
...
barplot(df2[,c(1,4,2)], names.arg=c("Number of OTUs","Number of Subclades","Number of Clades"), beside=TRUE, col=df2[,3],ylim = c(0,max(df2)),main="Corals by Site")
legend(50,90, inset=c(0.05,-0.05), legend=rownames(df2), fill=df2[,3],cex=0.55)
...
rownames(df2platy) <- c("Number of OTUs","Number of Clades", "Dist", "Number of Subclades")
df2platy <- t(df2platy)
...
par(xpd=TRUE,mar=c(3,3,3,11))
barplot(df2platy[,c(1,4,2)], names.arg=c("Number of OTUs","Number of Subclades","Number of Clades"), beside=TRUE, col=df2platy[,3],ylim = c(0,max(df2)),main="platys by Site")
legend(50,15, inset=c(0.05,-0.05), legend=rownames(df2platy), fill=df2platy[,3],cex=0.55)
...
rownames(df2fpenta) <- c("Number of OTUs","Number of Clades", "Dist", "Number of Subclades")
...
par(xpd=TRUE,mar=c(3,3,3,11))
barplot(df2fpenta[,c(1,4,2)], names.arg=c("Number of OTUs","Number of Subclades","Number of Clades"), beside=TRUE, col=df2fpenta[,3],ylim = c(0,max(df2)),main="fpentas by Site")
legend(50,30, inset=c(0.05,-0.05), legend=rownames(df2fpenta), fill=df2fpenta[,3],cex=0.55)
...
# Plot OTU and clade diversity by Disturbance level
```{r, include=TRUE, echo=FALSE, cache=TRUE}
...
rownames(df2dist) <- c("Number of OTUs","Number of Clades", "Number of Subclades")
df2dist <- t(df2dist)
...
barplot(df2dist[,c(1:3)], names.arg=c("Number of OTUs","Number of Subclades","Number of Clades"), beside=TRUE, col=mycols, ylim = c(0,max(df2dist)), main="Corals by Disturbance")
...
rownames(df2dist.platy) <- c("Number of OTUs","Number of Clades", "Number of Subclades")
...
par(xpd=TRUE,mar=c(3,3,3,3))
barplot(df2dist.platy[,c(1:3)], names.arg=c("Number of OTUs","Number of Subclades","Number of Clades"), beside=TRUE, col=mycols, ylim = c(0,max(df2dist)), main="Platys by Disturbance")
...
rownames(df2dist.fpenta) <- c("Number of OTUs","Number of Clades", "Number of Subclades")
...
par(xpd=TRUE,mar=c(3,3,3,3))
barplot(df2dist.fpenta[,c(1:3)], names.arg=c("Number of OTUs","Number of Subclades","Number of Clades"), beside=TRUE, col=mycols, ylim = c(0,max(df2dist)), main="fpentas by Disturbance")
...
```{r, include=TRUE, echo=FALSE, cache=TRUE}
# All corals
par(mar=c(12,5,1,1),xaxs="i",yaxs="i")
N=15
