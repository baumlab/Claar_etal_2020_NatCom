...
phy97.f.c.coral.KI2014 <- subset_taxa(phy97.f.c.coral.KI2014, taxa_sums(phy97.f.c.coral) > 0, prune=TRUE)
...
phy97.f.c.coral.KI2015a <- subset_taxa(phy97.f.c.coral.KI2015a, taxa_sums(phy97.f.c.coral) > 0, prune=TRUE)
...
phy97.f.c.coral.KI2015b <- subset_taxa(phy97.f.c.coral.KI2015b, taxa_sums(phy97.f.c.coral) > 0, prune=TRUE)
...
phy97.f.c.coral.KI2015c <- subset_taxa(phy97.f.c.coral.KI2015c, taxa_sums(phy97.f.c.coral) > 0, prune=TRUE)
...
phy97.f.c.coral.KI2016a <- subset_taxa(phy97.f.c.coral.KI2016a, taxa_sums(phy97.f.c.coral) > 0, prune=TRUE)
...
phy97.f.c.coral.AD.before.LVL <- subset_samples(phy97.f.c.coral.AD.before, Dist=="Low" | Dist=="VeryLow", prune=TRUE)
