...
phy97.f.c.fpenta.AD.before <- subset_samples(phy97.f.c.fpenta.AD,Year!="2016March")
phy97.f.c.fpenta.AD.before <- subset_samples(phy97.f.c.fpenta.AD.before,Year!="2015July")
...
# Do a constrained ordination on fpentagyra corals before the event
...
```{r richness_plot}
plot_richness(phy97.f.c.platy.AD, x="Status",color="Year", measures=c("Observed", "Chao1", "Shannon"))
...
p = plot_richness(phy97.f.c.platy.AD.Year, x="Year", color="Year", measures=c("Observed","Chao1", "Shannon"))
...
p = plot_richness(phy97.f.c.platy.AD.Status, x="Status", color="Status", measures=c("Observed","Chao1", "Shannon"))
p + geom_point(size=5, alpha=0.7)
...
p = plot_richness(phy97.f.c.platy.AD.before.Status, x="Status", color="Status", measures=c("Observed","Chao1", "Shannon"))
p + geom_point(size=5, alpha=0.7)
...
p = plot_richness(phy97.f.c.fpenta.AD.Status, x="Status", color="Status", measures=c("Observed","Chao1", "Shannon"))
p + geom_point(size=5, alpha=0.7)
```
