...
phy97.f.c.platy.AD.before <- subset_samples(phy97.f.c.platy.AD.before,field_season!="KI2016a")
phy97.f.c.platy.AD.before <- subset_samples(phy97.f.c.platy.AD.before,field_season!="KI2015c")
...
# Plot this ordination 
plot_ordination(phy97.f.c.platy.AD.before, ord.phy97.f.c.platy.AD.before,
                color="outcome", shape="disturbance_level",
                title="SymPortal - PCoA - Platy before")+
