...
sitedata <- read.csv(here::here("analyses/2020_analyses", "KI_Monitoring_Site_Names_for_Publications_Sept2019.csv"))
...
platy.nov <- ggplot(nov.pub.sum.disturb.platy, aes(x = disturb, y = prop, fill = bleach.bin)) +
  ...
  scale_x_discrete(labels = c("Very high" = "very high", "Medium" = "medium")) +
