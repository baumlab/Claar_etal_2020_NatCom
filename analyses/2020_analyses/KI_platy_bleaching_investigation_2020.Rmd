...
fpenta.nov <- ggplot(nov.pub.sum.disturb.fpenta, aes(x = disturb, y = prop, fill = bleach.bin)) +
  geom_bar(stat='identity', position='stack', color = "black") +
  labs(x = "Human Disturbance Level", y = "", fill = "Status")+
    scale_fill_manual(values = bleachcols.pub) +
  theme(axis.text.x = element_text(angle = 0), plot.background=element_blank(), 
        panel.background = element_blank(), 
        strip.background = element_blank(), strip.text = element_text(size = 13),
...
#add y axis labels
grid.text("Proportion of randomly sampled benthic\npoints at Medium disturbance sites", x = unit(0.03, "npc"), y = unit(0.56, "npc"), gp = gpar(fontsize=15), rot = 90)
grid.text("Proportion of individual colonies in November 2015", x = unit(0.525, "npc"), y = unit(0.55, "npc"), gp = gpar(fontsize=15), rot = 90)

#add panel lables
grid.text("a", x = unit(0.085, "npc"), y = unit(0.96, "npc"), gp = gpar(fontsize=18, face = "bold"))
grid.text("b", x = unit(0.57, "npc"), y = unit(0.96, "npc"), gp = gpar(fontsize=18, face = "bold"))
grid.text("c", x = unit(0.085, "npc"), y = unit(0.51, "npc"), gp = gpar(fontsize=18, face = "bold"))
grid.text("d", x = unit(0.57, "npc"), y = unit(0.51, "npc"), gp = gpar(fontsize=18, face = "bold"))
