...
#add in vl for the bow site
nov.pub$disturb <- ifelse(nov.pub$site == "bow", "Very low", nov.pub$disturb)
head(nov.pub)
...
platy.nov <- ggplot(nov.pub.platy, aes(x = disturb, y = prop, fill = bleach.prop.no4)) +
  geom_bar(stat='identity', position='stack', color = "black") +
  labs(x = "", y = "", fill = "Bleaching Proportion")+
    scale_fill_manual(values = bleachcols.pub2) +
...
fpenta.nov <- ggplot(nov.pub.fpent, aes(x = disturb, y = prop, fill = bleach.prop.no4)) +
  geom_bar(stat='identity', position='stack', color = "black") +
  labs(x = "", y = "", fill = "Bleaching Proportion")+
    scale_fill_manual(values = bleachcols.pub2) +
  theme(axis.text.x = element_text(angle = 0), plot.background=element_blank(), 
...
cn.sum.c.pub.platy <- cn.sum.c.pub[cn.sum.c.pub$Species == "Platygyra ryukyuensis", ]
...
grid.arrange(r, r, coralnet.platy, platy.nov, coralnet.fpent,  fpenta.nov, nrow=3, heights = c(0.08,0.45, 0.55))

#add y axis labels
grid.text("Proportion of random points", x = unit(0.01, "npc"), y = unit(0.56, "npc"), gp = gpar(fontsize=15), rot = 90)
...
grid.text("c", x = unit(0.05, "npc"), y = unit(0.54, "npc"), gp = gpar(fontsize=18, face = "bold"))
grid.text("d", x = unit(0.55, "npc"), y = unit(0.54, "npc"), gp = gpar(fontsize=18, face = "bold"))

#add sample sizes
##panel a
grid.text("96", x = unit(0.12, "npc"), y = unit(0.93, "npc"), gp = gpar(fontsize=12))
grid.text("90", x = unit(0.225, "npc"), y = unit(0.93, "npc"), gp = gpar(fontsize=12))
grid.text("44", x = unit(0.329, "npc"), y = unit(0.93, "npc"), gp = gpar(fontsize=12))
grid.text("67", x = unit(0.432, "npc"), y = unit(0.93, "npc"), gp = gpar(fontsize=12))

##panel b
grid.text("19", x = unit(0.64, "npc"), y = unit(0.93, "npc"), gp = gpar(fontsize=12))
grid.text("88", x = unit(0.775, "npc"), y = unit(0.93, "npc"), gp = gpar(fontsize=12))
grid.text("1", x = unit(0.91, "npc"), y = unit(0.93, "npc"), gp = gpar(fontsize=12))
  
##panel c
grid.text("22", x = unit(0.12, "npc"), y = unit(0.513, "npc"), gp = gpar(fontsize=12))
grid.text("77", x = unit(0.225, "npc"), y = unit(0.513, "npc"), gp = gpar(fontsize=12))
grid.text("20", x = unit(0.329, "npc"), y = unit(0.513, "npc"), gp = gpar(fontsize=12))
grid.text("10", x = unit(0.432, "npc"), y = unit(0.513, "npc"), gp = gpar(fontsize=12))
  
##panel d
grid.text("4", x = unit(0.64, "npc"), y = unit(0.513, "npc"), gp = gpar(fontsize=12))
grid.text("31", x = unit(0.775, "npc"), y = unit(0.513, "npc"), gp = gpar(fontsize=12))
grid.text("1", x = unit(0.91, "npc"), y = unit(0.513, "npc"), gp = gpar(fontsize=12))
