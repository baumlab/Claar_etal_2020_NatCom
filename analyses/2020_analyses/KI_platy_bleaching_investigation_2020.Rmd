...
## Notes    
KT went through every single photo and tallied each Merulinidae (except for F. speciosa and F. stelligara) that could be seen. The bleaching status of each was recorded using the scale above. There is a category of Favid which are corals that I could tell were a favid but I was unable to tell if it was Favia or Favites.
